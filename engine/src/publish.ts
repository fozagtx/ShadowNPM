...
const TEXT_RECORD_PREFIX = "shadownpm";
...
export async function publishAuditResults(
  ...
  const reportDir = fs.mkdtempSync(path.join(os.tmpdir(), "shadownpm-report-"));
  ...
  // packagePath is /tmp/shadownpm-xxx/extracted/package — tgz is at /tmp/shadownpm-xxx/package.tgz
