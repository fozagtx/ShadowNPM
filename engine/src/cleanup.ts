...
const ROOT_DOMAIN = process.env.SHADOWNPM_BASE_DOMAIN ?? "shadownpm.eth";
...
const PARENT_TEXT_KEYS = [
  "shadownpm.latest_version",
  "shadownpm.latest_verdict",
  "shadownpm.latest_score",
  "shadownpm.latest_report_cid",
  "shadownpm.latest_report_uri",
  "shadownpm.latest_source_cid",
  "shadownpm.latest_source_uri",
  "shadownpm.latest_capabilities",
  "shadownpm.latest_date",
];
