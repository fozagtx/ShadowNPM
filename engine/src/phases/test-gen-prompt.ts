...
export const TESTGEN_SYSTEM_PROMPT = `You are a security test engineer for ShadowNPM. Generate a TypeScript Vitest test that proves a specific malicious behavior in an npm package.
